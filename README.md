...
- Github Pages: https://viptv.work/hosts/

全新的`GitHub`访问加速工具，等待试用和反馈中，点击 [FastDev](https://github.com/viptv-work/hosts) 直达。

特点就是稳定！

> `hosts`地址可能会调整，所以请务必关注GitHub、Gitlab主页，保证不迷路。
...
请查看 [next hosts](https://github.com/viptv-work/hosts/blob/main/hosts)

内容定时更新，最近更新时间：2023-03-08 20:22:25。

```bash
# New！欢迎使用基于DNS的新方案
# https://github.com/viptv-work/hosts/blob/main/hosts
# 地址可能会变动，请务必关注GitHub、Gitlab获取最新消息
# 也可以关注公众号：湖中剑，保证不迷路
# GitHub Host Start

# Please Star : https://github.com/viptv-work/hosts
# Mirror Repo : https://github.com/viptv-work/hosts
...
```bash
curl -L https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-mac-arm64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-x64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-arm64.tar.gz | tar xzvf -
...
```bash
curl -L https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-linuxstatic-armv7.tar.gz | tar xzvf -
./hosts-server-pkg-linuxstatic-armv7/hosts-server --port=8888
```

### Windows

下载 https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-win-x64.zip ，解压后执行下面命令，服务会运行在： http://localhost:8888
...
- 方案名：GitHub（可以自行命名）
- 类型：远程
- URL 地址：https://github.com/viptv-work/hosts/-/raw/main/hosts
- 自动更新：1个小时（时间可自行调整）
