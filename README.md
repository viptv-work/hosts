...
```bash
curl -L https://github.com/viptv-work/hosts/releases/download/v1.0.1/hosts-server-pkg-mac-x64.tar.gz | tar xzvf -
...
- 方案名：GitHub（可以自行命名）
- 类型：远程
- URL 地址：https://gitlab.com/viptv-work/hosts/-/raw/master/hosts
- 自动更新：1 个小时（时间可自行调整）
...
- [GitHub Hosts](https://github.com/viptv-work/hosts)：GitHub 最新 hosts，定时更新
